  ...
  var GOL = {
    ...
    handlers : {
      ...
      buttons : {
        ...
        trail : function() {
          GOL.element.messages.layout.innerHTML = GOL.trail.current ? 'Der Pfad ist AUS' : 'Der Pfad ist AN';
        ...
        colors : function() {
          ...
          GOL.element.messages.layout.innerHTML = 'Farben Schema #' + (GOL.colors.current + 1);
          if (GOL.running) {
